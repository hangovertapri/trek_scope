  ...
  async function handleSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (result?.error) {
        ...
        const callbackUrl = searchParams.get('callbackUrl') || '/agency/dashboard';
  ...
  return (
    <>
      ...
      <p className="text-xs text-muted-foreground mt-4 pt-4 border-t">
        <strong>Development credentials:</strong> agency / agency123!
      </p>
    </>
  );
}
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-md mx-auto bg-card p-6 rounded-lg shadow border">
        <h1 className="text-3xl font-bold mb-2">Agency Login</h1>
        <p className="text-muted-foreground mb-6">Access your agency dashboard</p>
